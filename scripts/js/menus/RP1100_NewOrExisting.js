...
_ws.vm.addInitialPromptGroup();
  ...
  //{
    //_ws.vm.addInitialPrompt('RP1100_e_1');  /* Are you calling about a case that already exists? */
...
_ws.vm.addNomatchPromptGroup('1', 'sequence', false);
  ...
  _ws.vm.addNomatchPrompt('RP1100_r_2');  /* Are you calling about a case that has already been created?  Yes or no? */
...
_ws.vm.addNoinputPromptGroup('1', 'sequence', false);
  ...
  _ws.vm.addNoinputPrompt('RP1100_r_2');  /* Are you calling about a case that has already been created?  Yes or no? */
