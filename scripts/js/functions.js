...
_ws.setCTI_UserData = function(caseNumber, accountNumber, serialNumber, instrumentName, documentType, lotNumber, deliveryMethod, faxNumber, ivrNotes){
	...
	dataVar[0].name = "ivr_case_number";
	dataVar[0].type = "Str";
	...
	dataVar[1].name = "ivr_account_number";
	dataVar[1].type = "Str";
	...
	dataVar[2].name = "ivr_serial_number";
	dataVar[2].type = "Str";
	...
	dataVar[3].name = "ivr_instrument_name";
	dataVar[3].type = "Str";
	...
	dataVar[4].name = "ivr_document_type";
	dataVar[4].type = "Str";
	...
	dataVar[6].name = "ivr_delivery_method";
	dataVar[6].type = "Str";
...
_ws.defaultVDN = function(dnis, language){
	var transfer='';
	if (dnis == 'incomingRCCFrenchDNIS'){
		transfer = '30071';
	}else if (dnis == 'incomingASFrenchDNIS'){
		transfer = '36531';
	}else if (dnis == 'incomingRCCEnglishDNIS'){
		transfer = '30064';
	}else if (dnis == 'incomingASEnglishDNIS'){
		transfer = '36530';
	}else if (dnis == 'incomingRCCBiDNIS'){
		if (language == 'French'){
			transfer = '30071';
		} else {
			transfer = '30064';
		}
	}else if (dnis == 'incomingASBiDNIS'){
		if (language == 'French'){
			transfer = '36531';
		} else {
			transfer = '36530';
		}
	}else if (dnis == 'incomingRCCFrenchDNISTest'){
		transfer = '30071';
	}else if (dnis == 'incomingRCCBiDNISTest'){
		if (language == 'French'){
			transfer = '30071';
		} else {
			transfer = '30064';
		}	
	}else if (dnis == 'incomingRCCEnglishDNISTest'){
		transfer = '30064';
	}else if (dnis == 'incomingASFrenchDNISTest'){
		transfer = '36531';
	}else if (dnis == 'incomingASBiDNISTest'){
		if (language == 'French'){
			transfer = '36531';
		} else {
			transfer = '36530';
		}
	}else if (dnis == 'incomingASEnglishDNISTest'){
		transfer = '36530';
	}else if (dnis == 'incomingFrenchTissue'){
		if (language == 'French'){
			transfer = '36551';
		} else {
			transfer = '36560';
